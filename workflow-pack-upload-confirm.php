...
/* echo "<pre>"; 
print_r($_SESSION['wfaPostDataEdit']);
exit; */  
...
$namePack = explode('.',$packData['packFilePath']);
$filePath =$docRoot. $namePack[0].'/pack-info.xml';
...
<div id="body_content">
    ...
    <h2>Upload Workflow Pack</h2>
    	<form enctype="multipart/form-data" method="post" action="wfa-pack-review-confirm.php" name="upload_wfa_confirm" id="upload_wfa_confirm" onSubmit="return submitStoredWfa(document.upload_wfa_confirm);">
		...
		<ul>
        	<li>
            	 <ul><li>Pack details  <hr/></li>
                    ...
                    <!--li><label>Documentation<span>*</span></label>  
						<textarea id="wfa_help_doc_text"  name="wfa_help_doc_text" rows="30" class="confirm-textbox" placeholder="Enter help documentation" <?php echo $upfiletype;?> ></textarea>   
						<label></label>
            ...
            <li>
            	<ul> 
                	<li>Upload<hr/></li>
                    <li class="ralign">
						<input type="button" onclick="javascript:window.location.replace('pack-upload.shtml');" name="cancel" value="Cancel" class="myButton">
