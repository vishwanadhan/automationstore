      ...
      <div id="notaccordion">
									...
									<h3 id="silver-partners">
										<div class="accordion-bar-wrapper">
											<a name="silver-partners" class="accordion-bar">Creating an OnCommand Workflow Automation pack</a>
...
wfa-pack pack show - pack=new_pack_file_path</li>
										...
										<h3 id="silver-partners">
										<div class="accordion-bar-wrapper">
											<a name="silver-partners" class="accordion-bar">Exporting OnCommand Workflow Automation content</a>
...
Export all user-created
content as a single .dar file          
                <ul>
                    <li>Click Administration &gt; Export All.</li>
                    <li>In the Export As dialog box, specify a file name for the .dar file, and then click Export All.
        Export specific content 
                    <ul>
                        <li>Navigate to the required window from where you want to export content.</li>
                        <li>Select one or more content from the window and click   </li>
                        <li>In the Export As dialog box, specify a file name for the .dar file, and then click Export.</li>
                    </ul>
				</li>
       		 </ul>
</li> -->
...
<li> At the command prompt, enter the following command:
		<ul>
        	<li>Pack nameaft &#8226; Highly Confidential - ProdOps Restricted &#8226; Processed: Monday September 21 2015 03:35:28</li>
            <li>Pack version, which is in the nnn.nnn.nnn format</li>
            <li>Pack author</li>
            <li>Pack description</li>
        </ul>
</li>
<li>In the Save As dialog box, specify the location where you want to save the .dar file, and then
click Save.
</li> -->
