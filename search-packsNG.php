   ...
   <div id="body_content">
        ...
        <div class="simpleTabs">
					...
					<ul class="tabs1 tabswfpck"  style="width:100%;">
						<li><form name="submitForm1" method="post" action="search-packs.php">
							<input type="hidden" name="search" value="<?php echo $searchText;?>" /><a href="javascript:document.submitForm1.submit()" ><img src="images/netapp-certified-icon.png" width="20" height="20" border="0" align="absmiddle" style="margin-right:5px;">NetApp-Supported </a></form></li>
						 
						 <li><a href="#tab1"  class="selected"><img src="images/non-netapp-certified.png" width="20" height="20" border="0" align="absmiddle" style="margin-right:5px; margin-left:14px;">NetApp-Generated </a></li>	
						
						<li><form name="submitForm" method="post" action="search-packsNC.php">
							<input type="hidden" name="search" value="<?php echo $searchText;?>" /><a href="javascript:document.submitForm.submit()" ><img src="images/non-netapp-certified.png" width="20" height="20" border="0" align="absmiddle" style="margin-right:5px;">Community-Generated </a></form></li>
					</ul>
                    <ul class="tabs" >
      ...
      <table cellpadding="0" cellspacing="0" border="0"   class="tablesorter" id="mytable3">
        	<thead><tr>
				<th>Type</th>
                <th>Pack Name</th>
				...
				<?php } ?>
            	 ...
            	 <?php			 
					echo  $solrObj->getWorkflowResponse($searchText,"NETAPPG");
				 ?> 
            </tr>
        </table>
     ...
     <table cellpadding="0" cellspacing="0" border="0" class="tablesorter" id="mytable">
        	<thead><tr>
                ...
                <td></td>   
            	 ...
            	 <?php			 
					echo  $solrObj->getOCIResponse($searchText,"NETAPPG");
				 ?> 
            </tr>
        </table>
