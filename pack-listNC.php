...
$_SESSION['backPage']="pack-listNC.shtml";
//$userType = '1';/*testing */
...
<body >
	...
	<section> 
		...
		<ul class="tabs1 tabswfpck" >
			<li><a href="pack-list.shtml" ><img src="images/netapp-certified-icon.png" width="20" height="20" border="0" align="absmiddle" style="margin-right:5px;">NetApp-Supported Packs</a></li>
	...
	<div class="tab_container">
		...
		<table cellpadding="0" cellspacing="0" border="0">
				...
				?> 
					...
					<?php } ?>
					<td>Type</td>
					<td><?php echo orderBy("pack-listNC.php?searchtxt=$searchtxt","packName","Pack Name")?><?php if(!isset($_GET['order'])) {echo '<a href="#"><img src="images/orderup.png" border="0" />'; } ?></td>
					<td><?php echo orderBy("pack-listNC.php?searchtxt=$searchtxt","version","Latest Version")?><?php if(!isset($_GET['order'])) {echo '<a href="#"><img src="images/orderup.png" border="0" />'; } ?></td>
					<td><?php echo orderBy("pack-listNC.php?searchtxt=$searchtxt","minWfaVersion","Min WFA Version")?><?php if(!isset($_GET['order'])) {echo '<a href="#"><img src="images/orderup.png" border="0" />'; } ?></td>
					<td><?php echo orderBy("pack-listNC.php?searchtxt=$searchtxt","certifiedBy","Author")?><?php if(!isset($_GET['order'])) {echo '<a href="#"><img src="images/orderup.png" border="0" />'; } ?></td>              
					<td><?php echo orderBy("pack-listNC.php?searchtxt=$searchtxt","packDate","Released On")?><?php if(!isset($_GET['order'])) {echo '<a href="#"><img src="images/orderdown.png" border="0" />'; } ?></td>
					<td></td>
					<td></td>
					<?php 		
				if($userType == '1' ){
