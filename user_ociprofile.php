    ...
    <?php } ?>
        ...
        <div class="simpleTabs">
                    <ul class="tabs1 tabswfpck" >
						...
						<li><a href="#tab1" class="selected">OCI</a></li>						
         ...
         <div class="tab_container">
              ...
              <div class="tab_content mbot" id="tab1" style="display: block;">
                <h2 style="clear:both;">OCIs Downloaded</h2>
                    <hr>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="tablesorter">
                            <thead>
                                <tr>
                                    ...
                                    <th><span>Certified BY</span></th>

                                    <th  style="width:130px;"><span>Released On</span></th>
                            ...
                            <?php echo $ociObj->getUserDownloadedOCIPacks(); ?> 
                        </table>
                    </section >
                    <br/>
                    <br/>
                    <br/>
                    <br/>
                    <h2 style="clear:both;">OCIs Pending Administrator Approval</h2>
                    <hr>
                    <section class="packupload-div comman-link mbot">
                        <table cellpadding="0" cellspacing="0" border="0" class="tablesorter">
                            <thead>
                                <tr>
                            ...
                            <?php echo $ociObj->getUserPacks(); ?>
                        </table>
                    </section>
                    <br/>
                    <h2 style="clear:both;">OCIs Rejected</h2>
                    <hr>
                    <section class="packrejected-div comman-link">  
                        <table cellpadding="0" cellspacing="0" border="0" class="tablesorter">
                            ...
                            <?php echo $ociObj->getRejectedOCIPackData(); ?> 
