  ...
  <div id="notaccordion">
								<h3 >
										<div class="accordion-bar-wrapper">
											<a name="silver-partners" id="silver" class="accordion-bar">How to download workflow packs and import them in WFA for execution</a>
...
wfa-pack pack show - pack=new_pack_file_path</li>-->
       ...
       <ol>
            ...
            <li>Right-click on the workflow name, and then click <strong>Delete</strong></li>
									...
									<h3 >
										<div class="accordion-bar-wrapper">
											<a name="silver-partners" id="silver" class="accordion-bar">How to download report design files and import them in OnCommand Unified Manager for execution</a>
      ...
      <p>To import custom reports, you need to download the report design file from the Storage Automation Store and then import them into OnCommand Unified Manager software.<br><br>
        <strong>Before you begin : </strong>
        <ul>
        	<li>You must have installed OnCommand Unified Manager 6.2 or later version.</li>
            <li>You must have the necessary OnCommand Unified Manager login credentials. </li>
            <li>You must have the OnCommand administrator role to execute the custom reports in Unified Manager. </li>
        </ul>
     <br>
        <strong>Steps</strong>
       <ol> 
      <li>Log in to Storage Automation Store. 
<li>Using the Search filter, locate the appropriate report design(*.rptdesign) file.
<li>Click Download. 
<li>Save the report design (*.rptdesign) file in your local directory.
<li>Log in to Unified Manager by providing necessary credentials.
Before you import the report design (*.rptdesign) file, ensure that you have completed the tasks detailed in the Portability of Custom Reports section, 
refer  http://www.netapp.com/au/media/tr-4122.pdf. 

<li>From the Reports page, click Import Report.
<li>Locate the report design (*.rptdesign) file in your directory, and then click Open. 
<li>Provide name and description for the custom report and click on Import. 
The report design (*.rptdesign)  file is imported to OnCommand Unified Manager.

  </ol>
     
       
       <br>          
       <strong>After you finish</strong><br>
       Based on the name and description specified, you should be able to locate your custom report in the OnCommand Unified Manager Reports Page and you should be able to use the report as per your requirement.                   
</div>

<h3>
										<div class="accordion-bar-wrapper">
											<a name="silver-partners" id="silver" class="accordion-bar">How to download Performance Dashboard packs and import them for execution</a>
      ...
      <p>To import Performance Dashboards reports, you need to download the dashboard packs from the Storage Automation Store and then import them into advanced dashboard VA.<br><br>
        <strong>Before you begin : </strong>
        <ul>
        	<li>You must have contacted NetApp sales engineer for the location of the downloadable advanced dashboard VA with Graphite/Grafana and Harvest.</li>
            <li>You must have installed OnCommand Unified Manager 6.2 or later version.</li>
            <li>You must have the necessary OnCommand Unified Manager login credentials.</li>
        </ul>
     <br>
       ...
       <ol> 
     <li>Log in to Storage Automation Store. 
<li>Using the Search filter, locate the appropriate dashboard file(*.zip).
<li>Click Download. 
<li>Save the dashboard pack (*.zip) file in your local directory.
<li>Unzip and follow the direction in the readme file to install the dashboards. 
